...
import type { EscrowPool, EscrowPoolInterface } from '../EscrowPool';
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract LiquidityMiningManager',
        name: '',
        type: 'address',
      },
    ],
...
export class EscrowPool__factory {
  static readonly abi = _abi;
  static createInterface(): EscrowPoolInterface {
    return new utils.Interface(_abi) as EscrowPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): EscrowPool {
    return new Contract(address, _abi, signerOrProvider) as EscrowPool;
  }
}
